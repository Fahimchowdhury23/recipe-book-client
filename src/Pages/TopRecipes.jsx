...
const TopRecipes = () => {
  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 pb-10 w-11/12 xl:w-10/12 mx-auto">
      ...
      <div className="pb-10 text-center">
        <Link to="/allRecipes">
          <button className="btn p-6 rounded-xl font-bold text-accent/80 text-xl bg-gradient-to-r from-primary to-white border-0">
            See All Recipes
          </button>
        </Link>
      </div>
